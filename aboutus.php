  ...
  <body>
    ...
    <section id="History" class="p-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <h3>Sejarah X-Nano</h3>
                    <p><?php echo $baris[2];?></p>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="img/Headquater.jpg" class="card-img-top" alt="Headquarters">
                        <div class="card-body">
                            <p class="card-text text-canter">Headquarters, 20 March 2013</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="v&m" class="p-5">
        <div class="container">
            <div class="row">
                <h3 class="mb-4">Vision, Mision, Our Goal X-Nano</h3>
